...
public class SenhaTransferircontaActivity extends AppCompatActivity {

    private ActivitySenhaTransferircontaBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivitySenhaTransferircontaBinding.inflate(getLayoutInflater());
        ...
        reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (userProfile != null) {
                    ...
                    BiometricPrompt biometricPrompt = new BiometricPrompt(SenhaTransferircontaActivity.this, executor, new BiometricPrompt.AuthenticationCallback() {
                        @Override
